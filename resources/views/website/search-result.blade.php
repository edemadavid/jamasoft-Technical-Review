    ...
    <div id="content" class="container">
        <div class="panel panel-default">
            <div class="panel-body">
                <h6 class="nomargin">
                    Search Results for "{{ $query }}" {{$websites->count()}} results
                    <small class="text-success">(0.45 seconds) </small>
                </h6>
                ...
                <div class="clearfix search-result">
                    <h4>
                    <span class="badge badge-primary">{{ $website->category->name }}</span>

                        <a href="{{ route('websites.show', $website->id) }}">{{ $website->title }}</a>
                    </h4>
                    <small class="text-success">{{ $website->url }}</small>
                    <p>
                        {{ $website->description }}
                    </p>
                </div>
                ...
                <div class="text-center margin-top-20">
                    <ul class="pagination">
                        {{ $websites->appends(['query' => $query])->links() }}
                    </ul>
                </div>
            </div>
        </div>
