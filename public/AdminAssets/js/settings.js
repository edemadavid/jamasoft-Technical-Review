    ...
    var t = {
            ...
            2923: function (t, e, n) {
                ...
                t.exports = function (t, e, n, m, b, y, g) {
                    ...
                    var x,
                        ...
                        _ = T || L(b),
                        A = b ? (O ? L("entries") : _) : void 0,
                        C = ("Array" == e && P.entries) || T;
                    if (
                        (C &&
                            (w = l(C.call(new t()))) !== Object.prototype &&
                            w.next &&
                            (u(w, k, !0),
                            r || "function" == typeof w[f] || s(w, f, v)),
                        O &&
                            T &&
                            T.name !== h &&
                            ((j = !0),
            ...
            1181: function (t, e, n) {
                for (
                    ...
                    if (
                        x &&
                        (x[l] || a(x, l, p), x[f] || a(x, f, b), (c[b] = p), y)
                    )
                                ...
                                b =
                                    ...
                                    (v = e) &&
                                        ...
                                        i.test(v) &&
                                            ((m.user = !0), (m.pass = !0))),
                                    m);
                            for (d in ((h = e.match(i) || []), L))
                                b[d] ? (t[d] = s[L[d]] || "") : (t[d] = "");
                            if (
                                ((t.protocol = t.protocol.replace(a, "")),
                                (t.query = t.query.replace(c, "")),
                                (t.hash = P(t.hash.replace(u, ""))),
                                (t.user = P(h[1] || "")),
                                (t.pass = P(h[2] || "")),
                                (t.port =
                                    k[t.protocol] == t.port || 0 == t.port
                                        ? ""
                                        : t.port),
                                !b.protocol &&
                                    g.test(e.charAt(0)) &&
        ...
        (function () {
            ...
            const c = () => {
                    ...
                    document
                        ...
                        .forEach((t) => {
                            t.addEventListener("change", (t) => {
                                h(t.target.name, t.target.value),
                ...
                p = () => {
                    setTimeout(() => {
                        if (!b("visited")) {
                            document.querySelector(o).classList.toggle("open"),
                                y("visited", !0);
                        }
                    }, 1e3);
                },
                ...
                h = (t, e) => {
                    if ("theme" === t) {
                        ...
                        document
                            ...
                            .setAttribute("href", "css/".concat(t, ".css")),
                            a &&
                                a !== t &&
                ...
                b = (t) => localStorage.getItem("".concat(r).concat(t)),
                y = (t, e) => {
